...
walkSync(targetDir, function (filePath) {
    if (filePath.endsWith('.ts') || filePath.endsWith('.tsx')) {
        ...
        content = content.replace(/from\s+['"](?:\.\.\/)+ai\/(?:providers|types|smart-routing|usage-tracker|universal-router|usage-aggregation|test-provider|feature-resolver|router-vision|router-utils|provider-registry)['"]/g, "from '@ais/ai-engine'");

...
export function formatChangesForDiff(changes: Record<string, unknown> | null): string {
 ...
 */
export function formatChangesSummary(changes: Record<string, unknown> | null, maxLength: number = 100): string {
  if (!changes) return '-'
